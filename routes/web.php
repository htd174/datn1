...
Route::middleware(['auth'])->group(function () {
    Route::get('/payment/room/{booking_id}', 'Dashboard\PaymentController@processRoomPayment')->name('payment.room');
    Route::get('/payment/event/{booking_id}', 'Dashboard\PaymentController@processEventPayment')->name('payment.event');
    Route::post('/payment/confirm', 'Dashboard\PaymentController@confirmPayment')->name('payment.confirm');
});
