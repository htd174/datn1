                    ...
                    <div class="col-md-4">
                        <div class="to-ho-hotel-con">
                            <div class="to-ho-hotel-con-1">
                                ...
                                </div> <img src="{{'/storage/room_types/'.$room_type->images->first()->name}}" alt=""> </div>
            ...
            <div class="row">
                <div>
                    ...
                    <div class="col-md-3 n2-event">
                        ...
                        <!--event DETAILS-->
                        <div class="n22-event"> <a href="{{ url('/event/') }}"><h4>{{ $event->name }}</h4></a> <span class="event-date">Date: {{ $event->date }},</span> <span class="event-by"> Price: {{ $event->price > 0 ? '$'.number_format($event->price, 2, '.', ',') : 'Free'}}</span>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="bot-gal h-blog latest-reviews-section">
                        <h4 class="section-title">Latest Reviews</h4>
                        <ul class="latest-reviews-list">
                            @if(count($reviews) > 0)
                                @foreach($reviews as $review)
                                    <li class="latest-review-item" style="display: flex; align-items: flex-start; gap: 14px;">
                                        <img src="{{'/storage/avatars/'.$review->room_booking->user->avatar}}" alt="avatar" class="review-avatar" style="width:48px;height:48px;border-radius:50%;object-fit:cover;flex-shrink:0;">
                                ...
                                @endforeach
                            @else
                                <li class="latest-review-item">No reviews yet</li>
                            @endif
                        </ul>
                    </div>
                </div>
