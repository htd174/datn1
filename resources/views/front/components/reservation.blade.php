@section('reservation')
<!--PHẦN ĐẶT PHÒNG-->
<div class="hom-footer-section" style="background-color: #f7d678;">
    <div class="container">
        <div class="row">
            ...
            <div class="foot-com foot-2">
                <h5>Điện thoại: {{ config('app.phone_number', '977-9866893439') }}</h5>
            </div>
            <div class="foot-com foot-3">
                <a class="waves-effect waves-light" href="{{'/room_type'}}">Đặt phòng</a>
            </div>
        </div>
    </div>
</div>
