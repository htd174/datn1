...
@section('content')
    <div class="db-profile-view">
        <table>
            ...
            <tr>
                ...
                <th>Trạng thái duyệt đánh giá</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                ...
                <td>
                    @if(isset($room_booking->review->approval_status))
                        ...
                        @else
                            <span class="label label-default">Chưa có đánh giá</span>
                        @endif
                    @endif
                </td>
            </tr>
    ...
    <div class="db-profile-edit">
        ...
        {{ csrf_field() }}
        <div>
            <label class="col s4">Đánh giá</label>
        ...
        <div>
            <label class="col s4">Xếp hạng</label>
            <div class="input-field col s8">
                <div class="stars">
        ...
        <div>
            <div class="input-field col s8">
                <input type="submit" value="Cập nhật đánh giá" class="waves-effect waves-light pro-sub-btn"
                       id="pro-sub-btn">
            </div>
        </div>
        {!! Form::close() !!}
